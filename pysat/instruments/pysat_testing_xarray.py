...
def load(fnames, tag=None, sat_id=None, sim_multi_file_right=False,
    ...
    data['orbit_num'] = (('time'), ((fake_uts_root+num_array)/5820.).astype(int))
    ...
    data['int8_dummy'] = (('time'), np.array([1] * len(data.indexes['time']), dtype=np.int8))
    data['int16_dummy'] = (('time'), np.array([1] * len(data.indexes['time']), dtype=np.int16))
    data['int32_dummy'] = (('time'), np.array([1] * len(data.indexes['time']), dtype=np.int32))
    data['int64_dummy'] = (('time'), np.array([1] * len(data.indexes['time']), dtype=np.int64))
