# -*- coding: utf-8 -*-
"""Produces fake model data, similar in spirit to TIEGCM, for testing."""
...
def load(fnames, tag=None, inst_id=None, start_time=None, num_samples=96,
    ...
    uts, index, dates = mm_test.generate_times(fnames, num_samples, freq='1H',
    ...
    dummy0 = data['uts'] * data['ilev'] * data['latitude'] * data['longitude']
    dummy0 *= 0
    ...
    meta['altitude'] = {meta.labels.units: 'cm',
                        ...
                        meta.labels.desc: ' '.join(('Altitude (fake) for each',
                                                    'pressure level')),
                        meta.labels.notes: '',
    ...
    meta['iv_mer'] = {meta.labels.units: 'm/s',
                      ...
                      meta.labels.desc: ' '.join(('Non-physical meridional ion',
                                                  'drifts.')),
                      meta.labels.notes: '',
                      meta.labels.fill_val: np.nan}
