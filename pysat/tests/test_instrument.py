...
class TestBasics():
    ...
    def test_next_date_with_frequency_and_width_incl(self, values):
        ...
        start_date = values[0]
        stop_date = values[1]
        self.testInst.bounds = (start_date, stop_date, values[2], values[3])
        days_offset = pds.DateOffset(days=values[3] - 1)
