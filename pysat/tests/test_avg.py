...
class TestBasics():
    ...
    def test_basic_seasonal_average(self):
        ...
        results = pysat.ssnl.avg.median2D(self.testInst, [0., 360., 24.],
    ...
    def test_basic_orbit_mean(self):
        ...
        self.testInst.bounds = (pysat.datetime(2009, 1, 1),
...
class TestConstellation:
    ...
    def test_constellation_average(self):
        for i in self.testC.instruments:
            i.bounds = (pysat.datetime(2008, 1, 1),
                        pysat.datetime(2008, 2, 1))
        self.testI.bounds = (pysat.datetime(2008, 1, 1),
                             pysat.datetime(2008, 2, 1))
        resultsC = pysat.ssnl.avg.median2D(self.testC, [0., 360., 24.],
                                           'longitude', [0., 24, 24], 'mlt',
                                           ['dummy1', 'dummy2', 'dummy3'])
        resultsI = pysat.ssnl.avg.median2D(self.testI, [0., 360., 24.],
                                           'longitude', [0., 24, 24], 'mlt',
                                           ['dummy1', 'dummy2', 'dummy3'])
    ...
    def test_heterogenous_constellation_average(self):
        for inst in self.testC:
            inst.bounds = (pysat.datetime(2008, 1, 1),
                           pysat.datetime(2008, 2, 1))
        results = pysat.ssnl.avg.median2D(self.testC, [0., 360., 24.],
                                          'longitude', [0., 24, 24], 'mlt',
                                          ['dummy1', 'dummy2', 'dummy3'])
        dummy_val = results['dummy1']['median']
        dummy_dev = results['dummy1']['avg_abs_dev']
...
class TestSeasonalAverageUnevenBins:
    ...
    def test_seasonal_average_uneven_bins(self):
        ...
        self.testInst.bounds = (pysat.datetime(2008, 1, 1),
                                pysat.datetime(2008, 2, 1))
        results = pysat.ssnl.avg.median2D(self.testInst,
                                          np.linspace(0., 360., 25),
                                          'longitude',
                                          np.linspace(0., 24., 25), 'mlt',
                                          ['dummy1', 'dummy2', 'dummy3'],
                                          auto_bin=False)
        dummy_val = results['dummy1']['median']
        dummy_dev = results['dummy1']['avg_abs_dev']
